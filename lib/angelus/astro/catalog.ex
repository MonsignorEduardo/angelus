...
defmodule Angelus.Astro.Catalog do
  ...
  @kernels [
    ...
    %{
      ...
      range: {~D[1962-01-20], ~D[2125-01-01]},
      source: %{
        kind: :url,
        url:
    ...
    %{
      ...
      source: %{
        kind: :url,
        url:
          "https://github.com/MonsignorEduardo/angelus/releases/download/kernels-v0.1/20002060.bsp",
    ...
    %{
      ...
      source: %{
        kind: :url,
        url:
          "https://github.com/MonsignorEduardo/angelus/releases/download/kernels-v0.1/20000001.bsp",
    ...
    %{
      ...
      source: %{
        kind: :url,
        url:
          "https://github.com/MonsignorEduardo/angelus/releases/download/kernels-v0.1/20000002.bsp",
    ...
    %{
      ...
      source: %{
        kind: :url,
        url:
          "https://github.com/MonsignorEduardo/angelus/releases/download/kernels-v0.1/20000003.bsp",
    ...
    %{
      ...
      source: %{
        kind: :url,
        url:
          "https://github.com/MonsignorEduardo/angelus/releases/download/kernels-v0.1/20000004.bsp",
    ...
    %{
      ...
      source: %{
        kind: :url,
        url:
          "https://github.com/MonsignorEduardo/angelus/releases/download/kernels-v0.1/20136199.bsp",
